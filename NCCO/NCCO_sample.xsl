...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        <html>
            <head>
                <title>Variations of Cheap in a Sample of Early Nineteenth Century Writings</title>
            </head>
            <body>
                <h1>Sample of Early Nineteenth Century Use of Cheap</h1> 
                <h4>(gathered from NCCO)</h4>
                <table>
                    <tr>
                        <th>Author</th>
                        <th>Title</th>
